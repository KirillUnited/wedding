...
$(document).ready(function () {
    ...
    /**
    * homepage init slick slider default 
    */
    initDefaultSlider();
...
$(document).ready(function () {
    $.ajax({
        ...
        data: {
            sVendorUrlName: window.location.pathname.split("/").slice(-1)[0]
        },
        dataType: "JSON",
        success: function (data) {
            ...
            if (RES_JSON.length > 0) {
                var timerId = setInterval(function () {
                    ...
                    POPUP_FLAG.attr('src', 'https://f5prodstoragecontainer.blob.core.windows.net/prod-live-public/theme/images/' + RES_JSON[i].sFlagIconFileName);
